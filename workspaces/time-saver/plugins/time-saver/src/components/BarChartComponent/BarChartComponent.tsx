...
import { GetStatsByTemplateTaskIdResponse, isTimeSaverApiError } from '@alithya-oss/plugin-time-saver-common';
...
export function BarChart({
  ...
  const [data, setData] = useState<GetStatsByTemplateTaskIdResponse | null>(
    null,
  );
