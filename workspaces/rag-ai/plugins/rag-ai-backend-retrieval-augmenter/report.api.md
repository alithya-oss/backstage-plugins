## API Report File for "@alithya-oss/backstage-plugin-rag-ai-backend-retrieval-augmenter"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import { AugmentationIndexer } from '@alithya-oss/backstage-plugin-rag-ai-node';
import { AugmentationPostProcessor } from '@alithya-oss/backstage-plugin-rag-ai-node';
import { AugmentationRetriever } from '@alithya-oss/backstage-plugin-rag-ai-node';
...
import { EntityFilterShape } from '@alithya-oss/backstage-plugin-rag-ai-node';
import { LoggerService } from '@backstage/backend-plugin-api';
import { RecursiveCharacterTextSplitter } from 'langchain/text_splitter';
import { RetrievalPipeline } from '@alithya-oss/backstage-plugin-rag-ai-node';
import { RetrievalRouter } from '@alithya-oss/backstage-plugin-rag-ai-node';
