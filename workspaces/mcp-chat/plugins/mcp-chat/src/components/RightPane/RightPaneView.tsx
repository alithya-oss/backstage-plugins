...
import { MCPServer, ConversationRecord, Tool } from '../../types';
import { UseProviderStatusReturn } from '../../hooks';
import type { TabType } from './useRightPane';

export interface RightPaneViewProps {
...
export const RightPaneView: FC<RightPaneViewProps> = props => {
  const {
    sidebarCollapsed,
    onToggleSidebar,
    onNewChat,
