...
/**
 * Inner chat page content without the Page/Content shell.
 * Used directly by the alpha entry point (PageBlueprint provides the page shell)
 * and wrapped with Page/Content by the legacy entry point.
 */
export const ChatPageContent = () => {
  ...
  // Combine errors from different sources — all are Error | undefined
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err
          : new Error(`Failed to load conversation: ${err}`),
      );
    }
  };
    ...
    >
      ...
      >
        {combinedError ? (
          ...
          >
            <ResponseErrorPanel error={combinedError} defaultExpanded />
          </Box>
        ) : (
          <>
            {/* Chat Container */}
