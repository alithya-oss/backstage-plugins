...
yarn add --cwd packages/app @alithya-oss/plugin-aws-apps-for-backstage@0.2.0
```
...
import {
  ...
  AwsComponentPage,
} from '@alithya-oss/plugin-aws-apps-for-backstage';
...
[imports...]
+ import { AppCatalogPage } from '@alithya-oss/plugin-aws-apps-for-backstage';
