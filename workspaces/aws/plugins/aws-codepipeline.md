...
```shell
yarn workspace backend add @alithya-oss/backstage-plugin-aws-codepipeline-backend
```
...
} from '@alithya-oss/backstage-plugin-aws-codepipeline-backend';
...
```shell
yarn workspace app add @alithya-oss/backstage-plugin-aws-codepipeline
```
...
```tsx
import { EntityAwsCodePipelineCard } from '@alithya-oss/backstage-plugin-aws-codepipeline';
