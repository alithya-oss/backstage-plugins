...
```shell
yarn workspace backend add @alithya-oss/scaffolder-backend-module-aws-core
```
...
import { createAwsCloudControlCreateAction } from '@alithya-oss/scaffolder-backend-module-aws-core';
