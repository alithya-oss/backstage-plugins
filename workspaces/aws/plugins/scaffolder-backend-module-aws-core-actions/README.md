...
```shell
yarn workspace backend add scaffolder-backend-module-aws-core
```
...
// ...
backend.add(import('scaffolder-backend-module-aws-core'));
// ...
backend.start();
```
...
import { createAwsCloudControlCreateAction } from 'scaffolder-backend-module-aws-core';
