...
# AWS Apps on AWS Scaffolder Actions Plugin

## Overview

The AWS Apps Scaffolder Actions plugin extends Backstage's scaffolder with custom actions specifically designed for AWS resource creation and management. This plugin enables software templates to provision and configure AWS resources and interact with AWSEnvironment and AWSEnvironmentProvider configurations as part of the scaffolding process.

## Installation

```sh
# From your Backstage root directory
yarn add --cwd packages/backend @alithya-oss/backstage-plugin-scaffolder-backend-aws-apps@0.4.0
```
...
[...]
+backend.add(import('@alithya-oss/backstage-plugin-scaffolder-backend-aws-apps'));
[...]
...
You can filter by "aws-apps" to see all actions contributed by AWS Apps with usage examples.
