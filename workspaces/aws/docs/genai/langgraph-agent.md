...
The `@alithya-oss/backstage-plugins-aws-genai-agent-langgraph` package implements an agent for the Generative AI plugin for Backstage based on [LangGraph.js](https://github.com/langchain-ai/langgraphjs).
