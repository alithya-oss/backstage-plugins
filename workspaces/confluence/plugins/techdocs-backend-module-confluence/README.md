...
yarn --cwd packages/backend add @alithya-oss/backstage-plugin-techdocs-backend-module-confluence
```
...
backend.add(
  import('@alithya-oss/backstage-plugin-techdocs-backend-module-confluence'),
);
backend.start();
```
